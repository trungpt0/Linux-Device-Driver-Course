...
static int __init tasket_static_driver_init(void)
{
...
static void __exit tasket_static_driver_exit(void)
{
 ...
 */
module_init(tasket_static_driver_init);
module_exit(tasket_static_driver_exit);
...
MODULE_DESCRIPTION("Tasket Static Linux Driver");